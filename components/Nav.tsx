      ...
      <div className="container mx-auto px-4 lg:px-10 py-4 flex items-center justify-between">
        ...
        <div className="lg:flex w-full lg:w-auto lg:items-center hidden">
          <ul className="flex flex-row lg:space-x-4 mr-2 w-full lg:w-auto items-center space-x-6">
            <li>
              <Link href="/" className="text-gray-800 hover:text-blue-500 px-2 py-1">
                Home
              </Link>
            </li>
            <li>
              <Link href="product" className="text-gray-800 hover:text-blue-500 px-2 py-1">
                Products
              </Link>
            </li>
            <li>
              <Link href="/category" className="text-gray-800 hover:text-blue-500 px-2 py-1">
                Category
              </Link>
            </li>
          </ul>
          ...
          <div className="flex items-center space-x-4 mt-4 lg:mt-0">
            <Link href="profile" aria-label="Profile" className="text-xl text-gray-700">
              <CgProfile />
            </Link>
            <Link href="wishlist" aria-label="Wishlist" className="text-xl text-gray-700">
              <FaHeartCirclePlus />
            </Link>
            <Link href="cart" aria-label="Cart" className="text-xl text-gray-700">
              <IoIosCart />
            </Link>
            <Link href="checkout" aria-label="Checkout" className="text-xl text-gray-700">
              <IoBagCheckOutline />
            </Link>
            <Link
              href="/login"
      ...
      >
        ...
        >
          ...
          <ul className="flex flex-col items-center space-y-6 py-4">
            <li>
              <Link href="/" className="text-gray-800 hover:text-blue-500 px-4 py-2">
                Home
              </Link>
            </li>
            <li>
              <Link href="/product" className="text-gray-800 hover:text-blue-500 px-4 py-2">
                Products
              </Link>
            </li>
            <li>
              <Link href="/category" className="text-gray-800 hover:text-blue-500 px-4 py-2">
                Category
              </Link>
            </li>
            <li>
              <Link href="/profile" aria-label="Profile" className="text-gray-700 hover:text-blue-500 px-4 py-2">
                <CgProfile />
              </Link>
            </li>
            <li>
              <Link href="/wishlist" aria-label="Wishlist" className="text-gray-700 hover:text-blue-500 px-4 py-2">
                <FaHeartCirclePlus />
              </Link>
            </li>
            <li>
              <Link href="/cart" aria-label="Cart" className="text-gray-700 hover:text-blue-500 px-4 py-2">
                <IoIosCart />
              </Link>
            </li>
            <li>
              <Link href="/checkout" aria-label="Checkout" className="text-gray-700 hover:text-blue-500 px-4 py-2">
                <IoBagCheckOutline />
              </Link>
            </li>
            <li>
              <Link href="/login" className="inline-block mt-6 px-6 py-3 bg-[#6c4db47a] text-white border-spacing-8 border-4 border-[#2222] text-lg font-medium rounded-xl hover:bg-[#9373dd7a] transition">
                Login
              </Link>
            </li>
          </ul>
